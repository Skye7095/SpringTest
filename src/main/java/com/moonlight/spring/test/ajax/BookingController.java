...
import com.moonlight.spring.test.ajax.bo.BookingBO;
...
public class BookingController {
	...
	// 이름, 전화번호 전달 받고, 일치하는 결과 하나를 json 형태로 변환해서 response에 담는다
	@GetMapping("/main/confirm")
	@ResponseBody
	public Map<String, Object> confirmBooking(
			@RequestParam("name") String name
			, @RequestParam("phoneNumber") String phoneNumber) {
		
		Booking booking = bookingBO.getConfirmBooking(name, phoneNumber);
		
		// 조회가 성공하면 "result":"success"
